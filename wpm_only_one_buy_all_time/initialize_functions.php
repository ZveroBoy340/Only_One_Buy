<?php
/*
Plugin Name: WPM Only One Buy by All Time
Plugin URI: https://wp-masters.com/
Description: Restricted buy no more than 1 product without change quantity
Author: wp-masters
Version: 1.0
*/

define('PLUGIN_ONLY_ONE_PATH', plugins_url('', __FILE__));

class WPM_Only_One_Buy_by_All_Time
{
    private $settings;
    ...
    public function add_general_option()
    {
        ...
        ?>
        <p class="form-field">
            <input type="checkbox" name="buy_once" id="buy_once" value='1' <?php if($buy_once == '1') {echo 'checked';}?>>
...
new WPM_Only_One_Buy_by_All_Time();